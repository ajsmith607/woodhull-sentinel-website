...
A lightweight, static website for browsing and searching a collection of historical newspaper page images with accompanying OCR text. 

**Key Features:**
- Can be statically hosted or run in a non-networked environment (ideally)
- Full-text search across OCR'd newspaper content with search highlighting
